...
// -------------------
	$(".add-item").on('click', function(event) {
		  event.preventDefault();//refreshing the page
      var listItem = $(".item-input").val();//person's input
...
// -------------------
	$(".shopping-list").on('click', '.item-check', function(event) {
      $(event.currentTarget).toggleClass("complete");// Use event.currentTarget to add and remove the "complete" class to the checkbox
	});
// -------------------
